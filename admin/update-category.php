...
<div class="main-content">
    <div class="wrapper">
      ...
      <?php 
          ...
          if(isset($_GET['id']))
          {
            //Get the id and all othwer details
            ...
            {
                //redirect to manage category with sesion message
                     ...
                     if($image_name != "")
                     {
                       ...
                       if($current_image !="")
                       {
                        ...
                        if($remove==false){
                            ...
                            $_SESSION['failed-remove']="<dic class='error'>Failed to Remove Current Image.</div>";
                            header('location:'.SITEURL.'admin/manage-category.php');
